    ...
    public function getAll($request){
        ...
        if(!empty($educations))
        {
            foreach ($educations as $education)
            {
                ...
                $nestedData['action'] = '<a href="/admin/portfolio/education/'.$education->id.'/edit" title="Delete" onclick="userRemove()"><i class="fa fa-pencil-square-o fa-fw edit-icons edit"></i></a><a href="/admin/portfolio/education/delete/'.$education->id.'" title="Delete" onclick="userRemove()"><i class="fa fa-trash edit-icons del"></i></a>';
                $data[] = $nestedData;
